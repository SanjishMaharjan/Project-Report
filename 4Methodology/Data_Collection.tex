...
\begin{figure}[ht]
    ...
    \vspace{.5cm} % Add vertical space between images
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width= 4in ]{img/framesExtracted.jpg}
%     \caption{Video Sample}
% \end{figure}
% \hfill
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width= 4in ]{img/frames.jpg}
%     \caption{Frames Extracted from video}
% \end{figure}
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width= 4in ]{img/frameSelected.jpg}
